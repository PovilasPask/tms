 ...
 */
final class Version20190112160043 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game ADD home_team_id INT NOT NULL, ADD away_team_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game DROP home_team_id, DROP away_team_id');
    }
}
